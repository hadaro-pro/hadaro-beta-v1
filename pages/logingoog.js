...
function loginwithgoogle() {
  // function to for google sign-in
  const runGoogleSignIn = () => {
    const google_client_id =
      "615548516742-tgnelddahl41q457r0amut844mpoecv5.apps.googleusercontent.com";
  ...
  // function to for facebook sign-in
  const runFacebookSignIn = () => {
    const fb_client_id = "560358619285745";
    // const server_endpoint = "http://localhost:4000";

    const redirect_uri =
      "https://432d-102-89-47-187.ngrok-free.app/api/v2/auth/login-facebook";
