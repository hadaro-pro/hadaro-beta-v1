...
//   }, [lendNfts])
  ...
  return (
    <div>
      <Navbar />
      <PortfolioComp walletConnectStatus={isConnected}  ownedNfts={nfts}  loadingWallet={loadingWalletNfts}  lendingNfts={lendNfts} 
        loadingLendNfts={loadingLendingNfts} setLendingNfts={setLendNfts}  getNewListFunc= {handleGetLendingNfts} rentingNfts={rentingNfts} getNewListRentFunc={handleGetRentingNfts}  loadingRentNfts={loadingRentingNfts} />
      <Footer />
    </div>
  );
};
