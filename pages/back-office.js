...
const VerificationBackOffice = () => {
  ...
  const getAllPendingCollections = async () => {
    try {
      ...
      const filterDrafts = getCollections.data.filter(
  ...
  return (
    <div>
      <VerificationComp
        ...
        getPendingCollectionData={getAllPendingCollections}
        loadingPendingData={pendLoading}
        verifiedCollection={verifiedCollections}
        getVerifiedCollection={getAllVerifiedCollections}
        loadingVerifiedData={verifiedLoading}
