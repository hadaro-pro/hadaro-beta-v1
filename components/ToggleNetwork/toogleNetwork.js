  ...
  return (
    <div className={styles.mainCover}>
      ...
      <div className={styles.selectNetworkCover}>
              ...
              label: (
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  <img
                    ...
                    width={20}
                  />{" "}
                  <span style={{ marginLeft: ".5rem" }}> Ethereum </span>{" "}
                </div>
              ),
            },
            {
              ...
              label: (
                <div>
                  ...
                  <img
                    ...
                    width={20}
                  />{" "}
                  <span style={{ marginLeft: ".5rem" }}> Polyon </span>{" "}
                </div>
              ),
            },
            {
              ...
              label: (
                <div>
                  ...
                  <img
                    ...
                    width={20}
                  />{" "}
                  <span style={{ marginLeft: ".5rem" }}> Goerli </span>{" "}
                </div>
              ),
            },
          ]}
        ...
        <div>
          {" "}
          <button onClick={() => handleGetNFTs()}>Fetch My NFTs</button>{" "}
        </div>
      </div>
    </div>
  );
